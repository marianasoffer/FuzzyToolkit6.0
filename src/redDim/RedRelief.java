...
/*Implementation of the RELIEF attribute evaluation algorithm. This implementation is extended to include more neighbors in calculating the weights of the features
Es optimizacion local*/
...
public class RedRelief extends ReducDim{
	public RedRelief(double[][] dr,int nc){
		super(dr,nc);
